  ...
  return (
    <InputPrimitive
      ...
      className={cn(
        ...
        "autofill:shadow-[inset_0_0_0_1000px_var(--input)] autofill:[-webkit-text-fill-color:var(--foreground)] aria-invalid:autofill:[-webkit-text-fill-color:var(--destructive)] focus:placeholder:text-muted-foreground/50",
        className,
      )}
      {...props}
    />
